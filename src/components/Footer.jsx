      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: '1rem' }}>
            <a href="https://www.instagram.com/equinoxsports_club/" target="_blank" rel="noreferrer" style={{ color: 'var(--gold-primary)' }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"></line></svg>
            </a>
            <a href="https://www.facebook.com/profile.php?id=61554660353364" target="_blank" rel="noreferrer" style={{ color: 'var(--gold-primary)' }}>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <a href="https://maps.google.com/?q=P982+X7C+EQUINOX+sport+club,+Ouled+Hedadj" target="_blank" rel="noreferrer" style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem', color: 'var(--text-muted)', textDecoration: 'none', transition: 'color 0.3s' }} onMouseEnter={(e) => e.currentTarget.style.color = 'var(--gold-primary)'} onMouseLeave={(e) => e.currentTarget.style.color = 'var(--text-muted)'}>
